...
SWIFT_PROTOCOL("_TtP15WeavrComponents32SecurePasscodeFieldStackDelegate_")
@protocol SecurePasscodeFieldStackDelegate
@optional
- (void)onFocusChangeWithIndex:(NSInteger)index focused:(BOOL)focused;
...
SWIFT_PROTOCOL("_TtP15WeavrComponents25TextEntryCompleteDelegate_")
@protocol TextEntryCompleteDelegate
@optional
- (void)onTextEntryComplete:(SecureTextField * _Nonnull)textField;
- (void)onTextEntryUpdated:(SecureTextField * _Nonnull)textField;
@end
